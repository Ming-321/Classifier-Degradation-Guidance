...
from models.pipelines.cdg.sd3.pipeline import CDGSD3PAGPipeline
...
def main(
    ...
    """
    Call CDG method for text-to-image generation using SD3 PAG model
    Args:
    ...
    pipe = CDGSD3PAGPipeline.from_pretrained(
    ...
    if save_path_list is None:
        gen_images = []
    # Output information
    print("Use CDG SD3-PAG model to generate images")
...
if __name__ == "__main__":
    ...
    save_images(gen_images, "outputs/CDG/SD3_PAG")

# CUDA_VISIBLE_DEVICES=1 python models/runner/cdg/sd3_pag.py
