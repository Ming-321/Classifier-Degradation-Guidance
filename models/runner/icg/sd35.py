...
def main(
    ...
    """
    Call ICG method with SD3.5 model for text-to-image generation
    Args:
    ...
    pipe = ICGSD3Pipeline.from_pretrained(model_path, torch_dtype=torch.bfloat16)
    pipe.to("cuda")
    ...
    # Output information
    print("Use ICG SD3.5 model to generate images")
...
if __name__ == "__main__":
    ...
    save_images(gen_images, "outputs/ICG/SD3.5")
    # CUDA_VISIBLE_DEVICES=2 python models/runner/icg/sd35.py
