...
def main(
    prompts, guidance_scale=3.5, num_inference_steps=28, seed=42, save_path_list=None
):
    """
    Call CFG method with SD3.5 model for text-to-image generation
    Args:
    ...
    # Output information
    print("Use CFG SD3.5 model to generate images")
...
if __name__ == "__main__":
    ...
    save_images(gen_images, "outputs/CFG/SD3.5")
    # CUDA_VISIBLE_DEVICES=3 python models/runner/cfg/sd35.py
