...
def main(
    ...
    """
    Call SEG method with SD3 model for text-to-image generation
    Args:
    ...
    # Output information
    print("Use SEG SD3 model to generate images")
...
if __name__ == "__main__":
    ...
    save_images(gen_images, "outputs/SEG/SD3")
    # CUDA_VISIBLE_DEVICES=2 python models/runner/seg/sd3.py
