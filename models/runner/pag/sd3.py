...
def main(
    ...
    """
    Call PAG method with SD3 model for text-to-image generation
    Args:
    ...
    # Output information
    print("Use PAG SD3 model to generate images")
...
if __name__ == "__main__":
    ...
    # Aligns with experiment configuration: guidance_scale=1, pag_scale=3
    guidance_scale = 1.0
    pag_scale = 3.0
    ...
    # PAG parameters
    pag_applied_layers = ["blocks.13"]  # Apply to block 13 (lambda_block=13 in paper)
    ...
    save_images(gen_images, "outputs/PAG/SD3")
    # CUDA_VISIBLE_DEVICES=2 python models/runner/pag/sd3.py
