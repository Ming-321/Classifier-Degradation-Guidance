...
def main(
    ...
    """
    Call CADS method with SD3.5 model for text-to-image generation
    ...
    pipe = CADSSD3Pipeline.from_pretrained(model_path, torch_dtype=torch.bfloat16)
    pipe.to("cuda")

    gen_images = []

    # Output information
    print("Use CADS SD3.5 model to generate images")
...
if __name__ == "__main__":
    ...
    # Save images
    save_images(gen_images, "outputs/CADS/SD3.5")

    # CUDA_VISIBLE_DEVICES=3 python models/runner/cads/sd35.py
