#!/bin/bash
# Compare CFG, CADS, ICG, CDG methods on FLUX1.dev model. Evaluate with FID, CLIPScore, AestheticScore, VQAScore.
...
echo "Comparison table: $OUTPUT_BASE_DIR/flux_methods_comparison.csv"