...
METHODS=("cfg/sd35:cfg.json" "cads/sd35:cads.json" "icg/sd35:icg.json" "cdg/sd35:cdg.json" "seg/sd35:seg.json" "pag/sd35:pag.json")
MAX_PROMPTS=1600
GPUS="0"
SEED=42
PROMPT_SEED=2025
...
echo "Methods: CFG, CADS, ICG, CDG, SEG, PAG"
